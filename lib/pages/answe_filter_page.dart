...
class AnswerFilterPage extends StatefulWidget {
  @override
  _AnswerFilterPageState createState() => _AnswerFilterPageState();
}

class _AnswerFilterPageState extends State<AnswerFilterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('回答精选', style: TextStyle(fontSize: 18.0,),),
        centerTitle: true,
        elevation: 0.4,
      ),
      body: FutureBuilder(
